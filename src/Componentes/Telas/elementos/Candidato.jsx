...
export default function Candidato(props) {
    const [numCurtidas, setNumCurtidas] = useState(props.candidato.curtidas);
    const [numDescurtidas, setNumDescurtidas] = useState(props.candidato.descurtidas);

    function curtir(){
        props.candidato.curtidas = props.candidato.curtidas + 1;
        setNumCurtidas(props.candidato.curtidas);
    }
    function descurtir(){
        props.candidato.descurtidas = props.candidato.descurtidas + 1;
        setNumDescurtidas(props.candidato.descurtidas);
    }
